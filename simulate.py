...
if __name__ == "__main__":
    ...
    parser.add_argument("--Q_base",  type=float, required=True, help="Ambient task power in watts")
    parser.add_argument("--R_coupling", type=float, required=True, help="CPU-Heatsink thermal resistance (C/W)")
    parser.add_argument("--R_amb",   type=float, required=True, help="Heatsink-ambient thermal resistance (C/W)")
